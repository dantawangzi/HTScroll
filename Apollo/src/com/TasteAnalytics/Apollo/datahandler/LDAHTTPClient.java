 ...
 */
package com.TasteAnalytics.Apollo.datahandler;

/**
 *
 * @author Taste Analytics, LLC
 */
...
public class LDAHTTPClient {
    ...
    public LDAHTTPClient(String protocol, String host, String port) {
        ...
        String[] types
                = "topic,doc_to_topic,trans_doc_to_topic,top_docs,unorm_cat_bar,cat_bar,idx_slot,top_tf,top_y_kw_idx,term_idx,flat,topic_terms,top_sim,labeldict,label_topics,sent_agg,top_wt,agg_geo".split(",");
        String[] reduce
                = "terms,weights,weights,top_docs,weights,weights,weights,weights,top_terms,term,tree,weight,weights,dict,dict,pos,weight,result".split(",");
