...
//            add(new SimpleDateFormat("dd.MMM.yyyy"));
    ...
    public void processRecords() throws ParseException {
        ...
        for (int i = 0; i < allDocs.get(0).length; i++) {
            if (allDocs.get(0)[i].contains("date") || allDocs.get(0)[i].contains("StartDate") || allDocs.get(0)[i].contains("Year") || allDocs.get(0)[i].contains("time") || allDocs.get(0)[i].contains("Created_at")) {
                dateColumn = i;
                break;
            }
