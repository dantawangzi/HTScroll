...
public interface ParallelSpaceModel {
    ...
    public float getMinValue(int dimension);
     ...
     /**
     * Returns the maximum value for the given row.
     *
     * @return Maximum value for the given row.
     */
    public float getRecordMaxValue(int row);

    /**
     * @param row
     * @return standard deviation for the given row
     */
    public float getRecordSD(int row);

    /**
     * @param row
     * @return entropy value for the given row
     */
     ...
     */
     ...
     /**
     *
     * @Set the new sequence of topics based on their similarities
     */
